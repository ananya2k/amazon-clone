        ...
        <div className='home'>
           <div className='home_container'>
            ...
            <div className="home_row">
                ...
                rating={5}/>
                <Product title='Tenet (BIL/ Blu-ray + Digital + 4K Ultra HD)'
                price={10.00}
            ...
            <div className="home_row">
                <Product title='Nestle Quality Street Imported Caramels, Crèmes & Pralines, Christmas & Holiday Candy, 725 g'
                price={10.47}
                image="https://images-na.ssl-images-amazon.com/images/I/51nuYvWWqvL._AC_.jpg"
                rating={3}/>
                <Product title="Oster Prima Latte Espresso, Cappuccino and Latte Maker, Stainless Steel"
                price={249.99}
                image="https://images-na.ssl-images-amazon.com/images/I/81iC24QsowL._AC_SX679_.jpg"
                rating={4}/>
                <Product title="Canon SELPHY Square QX10 Compact Photo Printer (Pink)"
                price={157.89}
            ...
            <div className="home_row">
                <Product title="'Sceptre Curved 27' 75Hz LED Monitor HDMI VGA Build-in Speakers, Edge-Less Metal Black 2019 (C275W-1920RN)"
                price={336.67}
